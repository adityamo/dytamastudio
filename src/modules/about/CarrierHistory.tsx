          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
            <div className="flex flex-col space-y-4 lg:col-span-2">
              ...
              <p className="text-gray-500 dark:text-white text-sm font-normal">
                ini adalah beberapa pengalaman saya selama berkarir dibidang IT
              </p>
            </div>
                    ...
                    >
                      ...
                      <div className="-mt-2 space-y-5">
                        <div className="flex w-full justify-between">
                          ...
                          <div>
                            <time className="text-xs font-medium  px-5 py-2 bg-primary mt-4 mb-4 rounded-full text-white">
                              {item.start_date} - {item.end_date}
                            </time>
                          </div>
                        </div>

                        <p className="mt-2.5 text-sm text-gray-500 dark:text-white">
                          {item.job_desc}
                        </p>
                      </div>
                    </li>
